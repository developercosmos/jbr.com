...
import { SPORT_VALUES, SPORT_LABELS } from "@/lib/sports";
...
export function AddProductForm({ categories, brands, hasPickupAddress, videoLimits }: AddProductFormProps) {
    ...
    // Racket spec fields (NICHE) — power compare, spec search filters, match score.
    ...
    const handleSubmit = async (asDraft = false) => {
        ...
        try {
            ...
            const result = await createProduct({
                ...
                gender,
                sport: (sport || undefined) as (typeof SPORT_VALUES)[number] | undefined,
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-2">
                                        Menentukan grup produk di &quot;Browse by Sport&quot; &amp; filter pencarian.
                                    </p>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium mb-2 text-slate-500 dark:text-slate-400">
                    ...
                    <section className="bg-white dark:bg-surface-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select
                                    className="w-full appearance-none rounded-lg bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-brand-primary py-3 px-4"
                                    value={weightClass}
