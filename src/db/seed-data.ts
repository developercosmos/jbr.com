...
const categoriesData = [
    { name: "Raket", slug: "rackets", icon: "Target", image: productImages.rackets[0] },
    { name: "Sepatu", slug: "shoes", icon: "Footprints", image: productImages.shoes[0] },
    { name: "Tas", slug: "bags", icon: "Backpack", image: productImages.bags[0] },
    { name: "Pakaian", slug: "apparel", icon: "Shirt", image: productImages.apparel[0] },
    { name: "Shuttlecock", slug: "shuttlecocks", icon: "Circle", image: productImages.accessories[0] },
    { name: "Grip", slug: "grips", icon: "Zap", image: productImages.accessories[1] },
    { name: "Senar", slug: "strings", icon: "Gauge", image: productImages.accessories[2] },
    { name: "Aksesoris", slug: "accessories", icon: "Sparkles", image: productImages.accessories[0] },
];
